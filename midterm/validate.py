...
temp = float(input("Enter the average temperature on the interstate in kelvin: "))
rain = float(input("Enter the rain in mm for last hour: "))
snow = float(input("Enter the snow in mm for last hour: "))
cloud = float(input("Enter the cloud cover percentage: "))
...
yhat = test.dot(w)
print("The predicted traffic volume is {} vehicles.".format(yhat))
